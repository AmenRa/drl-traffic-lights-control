...
class DQNAgent:
    ...
    def __init__(self, state_size, action_size, memory_size=200, gamma=0.95, epsilon=1.0, epsilon_decay_rate=0.995, epsilon_min=0.01, learning_rate=0.0002, name='Swish_DQNAgent'):
    ...
    def _build_model(self):
        ...
        model.add(Dense(512, input_dim=self.state_size, activation=swish))
